...
export default function Dashboard() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      {/* Logo Header */}
      <div className="bg-[#1B5E9E] py-4 px-4 border-b border-white/10">
        <div className="max-w-6xl mx-auto flex justify-center md:justify-start">
          <img src="/logo.png" alt="DreamCap Financial Logo" className="h-10 md:h-12 w-auto brightness-0 invert" />
        </div>
      </div>
      {/* Dashboard Header */}
